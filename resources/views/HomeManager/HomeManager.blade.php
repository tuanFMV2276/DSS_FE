        ...
        <div id="product-management" class="table-container" style="display: none;">
            ...
            <div class="top-bar">
                ...
                <a href="{{ route('manager.createProduct') }}" class="btn btn-success"><button class="add-st"><i
                            class="fas fa-plus"></i>Add New Product</button></a>
            </div>
            ...
            <table border="1" data-status="products">
                ...
                <tbody id="product-body">
                    ...
                    <tr class="product-row">
                        ...
                        <td>{{ $product['product_code'] }}</td>
                        <td>{{ $product['product_name'] }}</td>
                        <td><img src="{{ asset('/Picture_Product/' . $product['image']) }}" alt="Product Image"
                                width="50%"></td>
                        <td>{{ $product['main_diamond_id'] }}</td>
                        ...
                        <td>
                            ...
                            <form action="{{ route('manager.destroyProduct', $product['id']) }}" method="POST"
                                style="display:inline-block;">
                                @csrf
                                @method('DELETE')
            ...
            <table border="1">
                ...
                <tbody id="shell-body">
                    ...
                    <tr class="shell-row">
                        ...
                        <td>{{ $shell['id'] }}</td>
                        <td>{{ $shell['name'] }}</td>
                        <td><img src="{{ asset('/Picture_Product/' . $shell['image']) }}" alt="Shell Image" width="20%">
                        </td>
                        <td>{{ $shell['price'] }}</td>
                        <td>{{ $shell['status'] }}</td>
                        <td><button>Update</button></td>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    orders.forEach(function(order, index) {
                        ...
                        var paymentMethod = order.payment ? order.payment
