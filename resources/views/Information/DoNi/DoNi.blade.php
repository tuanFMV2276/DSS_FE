...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css_Manh/dosize.css') }}">
...
<body>
    ...
    <div class="container">
        ...
        <div class="step">
            ...
            <img src="{{ asset('img_Manh/image/image 243.png') }}" alt="thước đo đường kính nhẫn">
        ...
        <div class="step">
            ...
            <p>Trong trường hợp bạn không tìm được chiếc nhẫn mẫu, có thể tham khảo cách đo thủ công khác: lấy một sợi
                ...
                tạo.</p>
            <img src="{{ asset('img_Manh/image/image 248.png') }}" alt="Quấn dây quanh ngón tay">
        ...
        <div class="step">
            ...
            <img src="{{ asset('img_Manh/image/image 250.png') }}" alt="Lưu ý đo size">
