...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('css_Hoa/CompletedProduct.css') }}"
        />
        <link
            rel="stylesheet"
                ...
                <div class="complete-icons-wrapper row">
                    <div class="complete-icons-block col-4">
                        <div class="complete-icon-img flex-center">
                            <img
                                src="{{asset('/Picture/CompletedProduct/icon-complete-1.jpg')}}"
                            />
                    ...
                    <div class="complete-icons-block col-4">
                        <div class="complete-icon-img flex-center">
                            <img
                                src="{{asset('/Picture/CompletedProduct/icon-complete-2.jpg')}}"
                            />
                    ...
                    <div class="complete-icons-block col-4">
                        <div class="complete-icon-img flex-center">
                            <img
                                src="{{asset('/Picture/CompletedProduct/icon-complete-3.jpg')}}"
                            />
