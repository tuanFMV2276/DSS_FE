    ...
    <div class="container">
        ...
        <form id="product-form" action="{{ route('manager.storeDiamondShell') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="diamond_shell_name" name="name" value="" required pattern="^[\p{L}\d\s]{1,30}$" title="Diamond Shell name should'nt contain any special characters and no more than 30 characters!.">
            </div>
            ...
            <div class="form-group">
                <label for="Price"><i class="fas fa-sort-numeric-up"></i> Price</label>
                <input type="number" class="form-control" id="diamond_shell_price" name="price" value="" min="0" max="99999999" step="500000" required>
            </div>

            <div class="form-group">
                <label for="main_diamond_id"><i class="fas fa-gem"></i> Material ID</label>
