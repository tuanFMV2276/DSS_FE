...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/detailshell.css') }}">
    <title>Brilliance</title>
</head>
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-7">
                <img src="{{ asset('img/image/ring.png') }}" alt="ring">
            </div>
            <div class="col-sm-5 text-center">
                ...
                <div class="col-sm-12 ring-size-wrapper mt-4">
                    <h4>Thêm chiếc nhẫn này</h4>
                    <select id="addRingTo">
                        <option value="add to diamond">Cùng với kim cương</option>
                        <option value="add to cart">Vào giỏ hàng</option>
                    </select>
                </div>
                <div class="col-sm-12 mt-3">
                    <div class="abtn">
                        <a href="dosize.blade.php" class="btn btn-lg custom-btn">Bước tiếp theo</a>
                    </div>
                    <p>Dự kiến giao hàng ngày 7/6/2024</p>
                </div>
                <div class="extend">
