...
$Cut_diamond = ["Excellent" , "Vary Good" , "Good" , "Poor" ];
$Polish_diamond = ["Excellent" , "Vary Good" , "Good" , "Poor" ];
    ...
    <div class="container">
        ...
        <form id="product-form" action="{{ route('manager.createMainDiamond') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="diamond_describe" name="description" value="" required pattern="^[\p{L}\d\s]{1,100}$" title="Diamond description should'nt contain any special characters!.">
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="polish" name="ppolish" required>
