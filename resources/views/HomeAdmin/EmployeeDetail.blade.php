...
<body>
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.updateEmployee', $employee['id']) }}" method="POST" onsubmit="return confirmSave()">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="role_id" name="role_id">
                            <option value='2' {{ old('role_id', $employee['role_id']) == '2' ? 'selected' : '' }}>Manager</option>
                            <option value='3' {{ old('role_id', $employee['role_id']) == '3' ? 'selected' : '' }}>Sales Staff</option>
