...
<html lang="vi">
  ...
  <body>
    ...
    <div class="col-large-12">
      <div class="col-inner">
        <div class="flex-row medium-flex-wrap container custom-filter">
                  ...
                  <div class="product-small box">
                    <div class="box-image">
                      <div class="image-none">
                        <a href="" aria-label="Nhẫn đính hôn Solitaire cổ điển bằng vàng">
                          <img width="247" height="296" src="" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail entered lazyloaded" alt="Nhẫn đính hôn Solitaire cổ điển bằng vàng"></img>
                        </a>
                      </div>
                    </div> 
                    <div class="text-center grid-style-2" style="32px">
                      <div class="tilte-wrapper">
                        <p class="name product-tilte"><a href="" class="" style="color: black">Nhẫn đính hôn Solitaire cổ điển bằng vàng</a></p>
                      </div>
                      <div class="text-center" style="32px; font-style: Bold; color: black">9.200.000VND</div>
                    </div>
                  </div>
                </div>
              </div>
